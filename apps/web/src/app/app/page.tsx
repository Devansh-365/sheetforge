...
import { type Project, deleteProject, listProjects } from '@/lib/api-client';
...
export default function ProjectsPage() {
  ...
  return (
    <div>
      ...
      {projects === null && !error && <p style={{ color: '#7f7a7a' }}>[*] loading projects…</p>}

      {projects !== null && projects.length === 0 && (
        <div className="border rounded p-8 text-center" style={{ borderColor: '#3d3838' }}>
          <p style={{ color: '#b8b2b2' }} className="mb-4">
        ...
        <ul className="space-y-2">
          {projects.map((p) => (
            ...
            >
              ...
              <DeleteIconButton onClick={() => onDelete(p)} label="delete" title="Delete project" />
            </li>
          ))}
        </ul>
      )}
